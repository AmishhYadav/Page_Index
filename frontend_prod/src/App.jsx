    ...
    try {
      ...
      setResult({
        ...
        citations: (data.citations || []).map(c => ({
          ...
          nodeCount: 1,
          score: 0.9, // Server doesn't return per-citation score yet
        })),
      });
    } catch (err) {
      await stagePromise;
      ...
      if (err.message.includes('fetch')) {
        setSearchError('Cannot connect to API. Make sure the backend is running on port 8000.');
      } else {
